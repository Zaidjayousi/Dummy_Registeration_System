...
import 'schema/registered_courses_record.dart';
...
export 'schema/registered_courses_record.dart';
...
/// Functions to query RegisteredCoursesRecords (as a Stream and as a Future).
Future<int> queryRegisteredCoursesRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RegisteredCoursesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RegisteredCoursesRecord>> queryRegisteredCoursesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      RegisteredCoursesRecord.collection(parent),
      RegisteredCoursesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RegisteredCoursesRecord>> queryRegisteredCoursesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
